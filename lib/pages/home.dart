...
class _HomePageState extends LocalizedState<HomePage> {
  ...
  _HomeItemDataModel? _getItems(BuildContext context) {
    ...
    final Map<String, Widget> homeItemsMap = {
      ...
      i18.home.stockSample: homeShowcaseData.stockSample.buildWith(
        child: HomeItemCard(
          icon: Icons.bar_chart_sharp,
          label: i18.home.stockSample,
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => const StockSamplePage(),
              ),
            );
          },
        ),
    ...
    final Map<String, GlobalKey> homeItemsShowcaseMap = {
      ...
      i18.home.stockSample: homeShowcaseData.stockSample.showcaseKey,
    ...
    final List<String> filteredLabels = homeItemsLabel
        .where((element) =>
            state.actionsWrapper.actions
                ...
                .contains(element) ||
            element == i18.home.db ||
            element == i18.home.stockSample)
        .toList();

    final showcaseKeys = filteredLabels
        .where((f) => f != i18.home.db && f != i18.home.stockSample)
