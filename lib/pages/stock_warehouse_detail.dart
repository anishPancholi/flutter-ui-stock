              ...
              children: [
                DigitCard(
                  ...
                  children: [
                    ...
                    //   validationMessages: {
                    //     'required': (_) => localizations
                    //         .translate("Team Code is required"),
                    //   },
                    //   builder: (field) => LabeledField(
                    //     label: localizations.translate("Team Code*"),
                    //     isRequired: true,
                    //     child: DigitTextFormInput(
                    //       formControlName: _teamCodeKey,
                    //       placeholder: localizations.translate("Enter Team Code"),
                    //     ),
                    //   ),
                    // ),
                    const SizedBox(height: 15),
...
class _ReceivedStockDetailsPageState extends State<ReceivedStockDetailsPage> {
  ...
  void _submitForm(FormGroup formGroup) {
    ...
    final receiverId = widget.warehouseData['facilityId'] as String;
                  ...
                  ReactiveWrapperField(
                    ...
                    builder: (field) => LabeledField(
                      ...
                      child: DigitDropdown<String>(
                        items: const [
                          DropdownItem(
                              name: 'District Health Facility 1', code: 'DHF1'),
                          DropdownItem(
                              name: 'District Health Facility 2', code: 'DHF2'),
                  ...
                  ReactiveWrapperField(
                    ...
                    builder: (field) => LabeledField(
                      ...
                      child: DigitTextFormInput(
                        ...
                        // formControlName: _quantityKey,
                        helpText: localizations.translate("Enter quantity"),
                  ...
                  ReactiveWrapperField(
                    ...
                    builder: (field) => LabeledField(
                      ...
                      child: DigitTextFormInput(
                        ...
                        helpText: localizations.translate("Enter comments"),
                        maxLength: 100,
                      ),
                    ),
                  ),
