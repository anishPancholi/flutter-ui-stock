...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    StockSampleRoute.name: (routeData) {
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const StockSamplePage(),
      );
    },
...
/// generated route for
/// [StockSamplePage]
class StockSampleRoute extends PageRouteInfo<void> {
  const StockSampleRoute({List<PageRouteInfo>? children})
      : super(
          StockSampleRoute.name,
          initialChildren: children,
        );

  static const String name = 'StockSampleRoute';
